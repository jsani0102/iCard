...
- (IBAction)enterFacebookAndInstagram:(id)sender {
    ...
    if ([self.facebookIDField.text length] == 0 || [self.instagramHandleField.text length] == 0)
    {
        UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Invalid Input"
                                                        message:@"Please input both a Facebook ID and an Instagram Handle."
                                                       delegate:nil
                                              cancelButtonTitle:@"OK"
                                              otherButtonTitles:nil];
        [alert show];
    ...
    else
    {
        ...
        UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:@"Thanks!" message:@"Your Instagram and Facebook information are now synced with your account" delegate: nil cancelButtonTitle:@"OK" otherButtonTitles:nil];
        [alertView show];
